...
public class RSAProducer {
    private static RSAProducer rsaProducer;
     ...
     */
    public static RSAProducer getInstance() throws Exception {
        if(rsaProducer.mypublicKey==null||rsaProducer.myprivateKey==null){
            synchronized (RSAProducer.class){
                if(rsaProducer.mypublicKey==null||rsaProducer.myprivateKey==null){
                    ...
                    rsaProducer.mypublicKey=publicKeyString;
                    rsaProducer.myprivateKey=privateKeyString;
                    return rsaProducer;
                }
            }
        }
